...
class FavoritesViewController: UITableViewController, ShowPostDelegate, AddPostDelegate {
    ...
    override func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        performSegue(withIdentifier: "showFavoritedPost", sender: indexPath)
    }
    ...
    func createArray(jsonobj : [String : Any]?) {
        ...
        posts = result["likes"] as! [[String : Any]]
